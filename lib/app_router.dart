...
import 'package:hu_library_app/features/auth/booking.dart' show BookingsScreen;
...
import 'package:hu_library_app/features/auth/Full Report.dart' show FullReportScreen;

import 'package:hu_library_app/features/auth/Support Ticket.dart' show AdminSupportTicketScreen;

import 'package:hu_library_app/features/auth/edit_ profile.dart' show AdminEditProfileScreen;
...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/arabic-book-purchase',
      builder: (context, state) => const ArabicBookPurchasePage(),
    ),

    GoRoute(
      path: '/foreign-book-purchase',
      builder: (context, state) => const ForeignBookPurchasePage(),
    ),

    GoRoute(
      path: '/thesis-inquiry',
      builder: (context, state) => const ThesisInquiryPage(),
    ),

    GoRoute(
      path: '/new-books',
      builder: (context, state) => const NewBooksPage(),
    ),
    ...
    GoRoute(
      path: '/librarian-info',
      builder: (context, state) => const LibrarianInfoPage(),
    ),
