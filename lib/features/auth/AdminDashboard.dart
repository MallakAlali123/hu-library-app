...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  Future<int> _getTotalBooks() async {
    try {
      AggregateQuerySnapshot snapshot =
          await _firestore.collection('books').count().get();
            ...
            children: [
              ...
              FutureBuilder(
                ...
                builder: (context, AsyncSnapshot<List<int>> snapshot) {
                  ...
                  return Column(
                    children: [
                      _buildMetricCard("Total Books",
                          "${snapshot.data![0]}", "+2.4%", Icons.book, Colors.green),
                      _buildMetricCard("Active Loans",
                          "${snapshot.data![1]}", "-1.2%", Icons.swap_horiz, Colors.red),
                      _buildMetricCard("Pending Suggestions",
                          "${snapshot.data![2]}", "Urgent", Icons.edit_note, Colors.orange),
                    ],
                  );
                },
              ),
      ...
      child: Column(
        ...
        children: [
          ...
          _actionButton("Generate Report", Icons.description_outlined,
              onTap: () => context.push('/admin/generate-report')),
  ...
  Widget _buildBottomNav(BuildContext context) {
    return BottomNavigationBar(
      ...
      onTap: (index) {
        switch (index) {
          case 0:
            context.push('/admin/suggestions');
            break;
          case 1:
  ...
  Widget _buildMetricCard(String title, String value, String badge,
      IconData icon, Color badgeColor) {
    return Card(
      elevation: 0,
