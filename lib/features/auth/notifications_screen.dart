      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: notification.isRead ? const Color(0xFFEEEEEE) : const Color(0xFFFFCCCC),
            ),
          ),
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                height: 44,
                decoration: BoxDecoration(
                  color: notification.type.bgColor,
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Icon(
...
extension NotifTypeExtension on NotifType {
  IconData get icon {
    switch (this) {
      case NotifType.returnBook:
        return Icons.assignment_return_outlined;
      case NotifType.approved:
        return Icons.check_circle_outline_rounded;
      case NotifType.available:
