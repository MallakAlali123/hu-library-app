...
class _LibraryServicesPageState extends State<LibraryServicesPage> {
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
              icon: Icon(Icons.assignment_turned_in), label: "Requests"),
          BottomNavigationBarItem(
              icon: Icon(Icons.menu_book), label: "Books"),
          BottomNavigationBarItem(
              icon: Icon(Icons.campaign), label: "Announce"),
  ...
  Widget _buildRequestsTab() {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const Text("Reservation Requests",
              style:
                  ...
                  return Card(
                    child: ListTile(
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () =>
                            _deleteDocument('books', books[index].id),
                      ),
                    ),
                  );
                },
          ...
          StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final announce = snapshot.data!.docs[index].data()
                    ...
                    child: ListTile(
                      ...
                      trailing: IconButton(
                        icon: const Icon(Icons.delete_outline,
                            color: Colors.red),
                        onPressed: () => _deleteDocument('announcements',
  ...
  Widget _buildProfileTab() {
    TextEditingController nameCtrl =
        TextEditingController(text: "Admin Librarian");
    TextEditingController emailCtrl =
        TextEditingController(text: "librarian@hu.edu.jo");
    TextEditingController branchCtrl =
        TextEditingController(text: "Main Library");
  ...
  Widget _buildLoanCard(
    ...
    final date = data['borrowDate'] != null
        ? (data['borrowDate'] as Timestamp)
            .toDate()
            .toString()
            .substring(0, 10)
        : '---';
    ...
    Color textColor =
        status == 'CONFIRMED' ? primaryRed : Colors.black54;
