...
class _LibraryServicesPageState extends State<LibraryServicesPage> {
  ...
  final List<_ServiceItem> _services = const [
    _ServiceItem(title: 'Book Suggestion', icon: Icons.lightbulb_outline_rounded, imageAsset: 'assets/images/book_suggestion.png'),
    _ServiceItem(title: 'Donate a book', icon: Icons.card_giftcard_rounded, imageAsset: 'assets/images/donate_book.png'),
    _ServiceItem(title: 'Reserved Requests', icon: Icons.bookmark_border_rounded, imageAsset: 'assets/images/reserved.png'),
    _ServiceItem(title: 'Hall Reservation', icon: Icons.meeting_room_outlined, imageAsset: 'assets/images/hall.png'),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        actions: [
          // ✅ أيقونة الجرس تفتح صفحة الإشعارات
          IconButton(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                const Text('Services & Requests', style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, color: Color(0xFF1A1A1A))),
                GestureDetector(
                  onTap: () {},
                  child: const Text('View All', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFFCC3333))),
                ),
              ],
            ),
            ...
            Positioned(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(child: Text(service.title, style: const TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w600))),
                ],
              ),
            ),
          ],
